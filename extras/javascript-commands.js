...
// schema
async function create_new_schema() {
  const url = "http://localhost:5001/api/v1/schemas";
  const payload = {
    schema: {
...
async function fetch_schema_by_identity() {
  const url =
    "http://localhost:5001/api/v1/schemas/schema:cord:57eeFhxzZVfwUmfWSz5TSgZB5AZnhCx5eECQ9XgWENpGEVR4";
  const response = await fetch(url);
  return await response.json();
  /**
   * {
...
async function fetch_all_schemas() {
  const url = "http://localhost:5001/api/v1/schemas";
  const response = await fetch(url);
  return await response.json();
...
async function revoke_schema() {
  const url =
    "http://localhost:5001/api/v1/schemas/schema:cord:595HpjtdExcKsce5dzaKTRwNBRoKbp6Xzs9udzbhC4WVXs2X/revoke";
  const response = await fetch(url);
  return await response.json();
...
async function create_space() {
  const url = "http://localhost:5001/api/v1/spaces";
  const payload = {
...
async function fetch_all_space() {
  const url = "http://localhost:5001/api/v1/spaces";
  const response = await fetch(url);
  return await response.json();
...
async function fetch_space_by_identity() {
  const url =
    "http://localhost:5001/api/v1/spaces/47phMdxzBSL3FofzD6jwJp7FfAnhMow4oHNCjYY31fieE8fv";
  const response = await fetch(url);
  return await response.json();
